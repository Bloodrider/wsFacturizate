...
namespace wsRepresentacionImpresa.App_Code.com.Facturaxion.facturaEspecial
{
    public class CGM101126IK6
    {
        ...
        public static string generarPdf(Hashtable htFacturaxion, HttpContext hc)
        {
            ...
            try
            {
                ...
                pathIMGLOGO = @"C:\Inetpub\repositorioFacturaxion\imagesFacturaEspecial\CGM101126IK6\Logoprobellblanco.png";
                pathIMGFX = @"C:\Inetpub\repositorioFacturaxion\imagesFacturaEspecial\CGM101126IK6\cfdifx.png";
                ...
                //Expedido en:
                cel = new Cell(new Phrase("Expedido en Sucursal:", titulo));
                cel.HorizontalAlignment = Element.ALIGN_CENTER;
                cel.BorderColor = gris;
                cel.BackgroundColor = azul;
                encabezadoComprobante1.AddCell(cel);
                ...
                if (timbrar)
                {
                    ...
                    {
                        par.Add(new Chunk(Convert.ToDouble(tasaCambio).ToString("C", _c2) + "   |   ", f5));
                    }
                    else
                    {
    ...
    public class DefaultSplitCharacterProbell : ISplitCharacter
    {
         ...
         */
        public static readonly ISplitCharacter DEFAULT = new DefaultSplitCharacterProbell();
