...
namespace wsRepresentacionImpresa.App_Code.com.Facturaxion.facturaEspecial
{
    public class MADERAS
    {
        ...
        public static string generarPdf(Hashtable htFacturaxion, HttpContext hc)
        {
            ...
            try
            {
                ...
                pdfPageEventHandlerMaderas pageEventHandler = new pdfPageEventHandlerMaderas();
                PdfWriter writer = PdfWriter.GetInstance(document, fs);
                writer.SetFullCompression();
                writer.ViewerPreferences = PdfWriter.PageModeUseNone;
                //writer.PageEvent = pageEventHandler;
                pdfPageEventHandlerMaderas ev = new pdfPageEventHandlerMaderas();
                writer.PageEvent = ev;
                ...
                pathIMGLOGO = @"C:\inetpub\RepositorioFacturaxion\imagesFacturaEspecial\MDT000203H37\Maderas_Derivados_Logo.png";
                pathIMGFX = @"C:\inetpub\RepositorioFacturaxion\imagesFacturaEspecial\MDT000203H37\cfdifx.png";
                ...
                // Còdigo de Barras
                cel = new Cell(new Phrase("Genero", titulo));
                cel.HorizontalAlignment = Element.ALIGN_CENTER;
                cel.BorderColor = gris;
                cel.BackgroundColor = azul;
                encabezadoDetalle.AddCell(cel);
                ...
                // Código
                cel = new Cell(new Phrase("      M3", titulo));
                ...
                // Se crea la tabla para insertar los conceptos de detalle de la factura
                ...
                String[] arrColWidthConceptos = { "7", "48", "12", "13", "13", "13" };
                ...
                sbOpcionalDetalle.
                    Append("SELECT campo3 as adicional ").
                ...
                for (int i = 0; i < numConceptos; i++)
                {
                    ...
                    //Columna Adicional
                    cellConceptos = new PdfPCell(new Phrase(dtOpcionalDetalle.Rows[i]["adicional"].ToString(), new Font(Font.HELVETICA, 7, Font.NORMAL)));
                    cellConceptos.Border = 0;
                ...
                cel = new Cell(new Phrase(htFacturaxion["observaciones"].ToString(), f5));
                cel.BorderWidthTop = 0;
                cel.BorderWidthLeft = (float).5;
                cel.BorderWidthRight = 0;
                cel.BorderWidthBottom = (float).5;
                ...
                if (timbrar)
                {
                    ...
                    if (electronicDocument.Data.FolioFiscalOriginal.Value.ToString().Length > 0)
                    {
                        ...
                        par.Add(new Chunk(electronicDocument.Data.MontoFolioFiscalOriginal.Value + "   |   ", f5));
                    }
                ...
                ev.encFolioFiscal = encabezadoFolio;
                ev.encComprobante = encabezadoComprobante;
                ev.encComprobante1 = encabezadoComprobante1;
                ev.encTitulos = encabezadoDetalle;
                ev.adicional = adicional;
                ev.footer = footer;
    ...
    public class pdfPageEventHandlerMaderas : PdfPageEventHelper
    {
        #region "variables"
    ...
    public class DefaultSplitCharacterMaderas : ISplitCharacter
    {
         ...
         */
        public static readonly ISplitCharacter DEFAULT = new DefaultSplitCharacterMaderas();
